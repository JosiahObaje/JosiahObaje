     ...
     <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="col-md-12">
          ...
          <div class="form-group">
            <label>Entrance Level</label>
            <select class="form-control" name="year_level" id="year_level">
              <option value="0">Select Entrance level</option>
              <option value="first year">Junior Secondary School I</option>
              <option value="second year">Junior Secondary School II</option>
              <option value="third year">Senior Secondary School I</option>
              <option value="fourth year">Senior Secondary School II</option>
            </select>
          </div>
          <div class="form-group">
            <label>Email</label>
